...
<header>
	...
	<nav>
		...
		<ul>
			...
			<li aria-current={$page.url.pathname === '/efectotexto' ? 'page' : undefined}>
				<a href="/about">Efecto 1</a>
			</li>
			<li aria-current={$page.url.pathname === '/efectotexto' ? 'page' : undefined}>
				<a href="/efecto2">Efecto 2</a>
			</li>
			<li aria-current={$page.url.pathname === '/efectotexto' ? 'page' : undefined}>
			...
			<li aria-current={$page.url.pathname === '/efectotexto' ? 'page' : undefined}>
				<a href="/efecto8">Efecto 8</a>
			</li>
			<li aria-current={$page.url.pathname === '/efectotexto' ? 'page' : undefined}>
				<a href="/efecto9">Efecto 9</a>
			</li>
	...
	<div class="corner">
		<a href="https://github.com/Irina-Ichim/SvelteEfectosTexto">
